// twee prompts om de waarde in de variablen te krijgen en deze waardes vermenigvuldigen
getal1 = prompt('Typ het eerste getal');
...
document.write ('Deze getallen vermenigvuldigd zijn: ' + resultaat);
