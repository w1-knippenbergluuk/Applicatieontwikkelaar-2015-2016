...
?>
            ...
            <div id="content">
                <h1>RUTH VAN DE POL </h1>
            
                <div class="lidTest">
                    <div class="ledenImage">
                        <p><span class="boldLid">Ruth van de Pol</span> <br /> Beeldend Kunstenaar </p>
                        <img src="images/ruthbw.jpg" alt="Carola Bouchoms"/>
                    </div>
                    ...
                    <div class="ledenText">
                        ...
                        <p>
                            De dagelijkse verwondering, ervaringen in de directe omgeving geven mij inspiratie, 
                            zo niet “dwingen” mij elke dag verslag te doen van grote en kleine gebeurtenissen.
                        </p>
                        <p>
                            Tijdens wandelingen neem ik waar, verzamel materiaal, objecten en geluiden, teken en vertaal en speel met hun betekenissen. 
                            Dit levert afwisselend concrete of meer associatieve tekeningen, foto’s (polaroid) of concepten op voor (monumentaal) ruimtelijk werk. 
                            Dit komt in mijn atelier samen met de niet-tastbare werkelijkheid zoals gedachten en herinneringen. 
                            Zo komen “dingen samen” en zijn ze de bron van een relatie tussen plaats en tijd.
                        </p>
                        <p>
                            Schilderijen ontstaan vanuit gedachteschetsen en worden vervolgens vanuit een lijnenspel gevormd tot een 
                            compositie waarin gelaagdheid en handschrift belangrijk zijn. 
                            Kleuren zijn uitbundig of ingetogen en de verf ligt in transparante lagen op het doek. 
                            Er vormt zich een opeenstapeling van beelden. Zij ontstaan in een proces van voortdurende verandering en groei.
                        </p>
                        <p>
                            Disciplines: tekenen, schilderen, mixed media, conceptueel/ monumentaal, (Ruimtelijke) werken , installaties (vrij, projectmatig of in opdracht).
                        </p>
                    </div>
                </div>
                <section>
                    ...
                    <div id="images">
                        ...
                        <a class="example-image-link" href="images/ruth/red-light-493x480.jpg" data-lightbox="example-set" data-title="Red light"><img class="example-image" src="images/ruth/red-light-180x180.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/atlantis-res.-392x480.jpg" data-lightbox="example-set" data-title="Atlantis res"><img class="example-image" src="images/ruth/atlantis-res.-180x180.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/sine-dubio.jpg" data-lightbox="example-set" data-title="Sine dubio"><img class="example-image" src="images/ruth/sine-dubio-180x180.jpg" alt=""/></a>
                    ...
                    <div id="images">
                        ...
                        <a class="example-image-link" href="images/ruth/red-light-493x480.jpg" data-lightbox="example-set" data-title="Red light"><img class="example-image" src="images/ruth/bw/red-light-180x180bw.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/atlantis-res.-392x480.jpg" data-lightbox="example-set" data-title="Atlantis res"><img class="example-image" src="images/ruth/bw/atlantis-res.-180x180bw.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/sine-dubio.jpg" data-lightbox="example-set" data-title="Sine dubio"><img class="example-image" src="images/ruth/sine-dubio-180x180.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/reflections1.jpg" data-lightbox="example-set" data-title="Reflections 1"><img class="example-image" src="images/ruth/reflections1-180x180.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/work-in-progress.jpg" data-lightbox="example-set" data-title="Work in progress"><img class="example-image" src="images/ruth/work-in-progress-180x180.jpg" alt=""/></a>
                        <a class="example-image-link" href="images/ruth/foto-11-640x480.jpg" data-lightbox="example-set" data-title="Atelier detail"><img class="example-image" src="images/ruth/foto-11-180x180.jpg" alt=""/></a>
